...
import (
	...
	sidesave "github.com/bytethecookie/sidesave"
	"github.com/bytethecookie/sidesave/internal/api"
	"github.com/bytethecookie/sidesave/internal/changelog"
...
func (a *App) startup(ctx context.Context) {
	...
	if a.updatedFrom != "" {
		d.Log.Log("success", "SideSave updated: "+a.updatedFrom+" → "+AppVersion)
	}
...
func (a *App) AppInfo() map[string]string {
	return map[string]string{
		...
		"license":   "MIT",
		"copyright": "© 2026 Siva Prakash & SideSave contributors",
		"tech":      "Go + Wails",
	}
}
...
func (a *App) ChangelogReleases() []changelog.Release {
	return changelog.Parse(sidesave.Changelog)
}
...
func (a *App) WhatsNew() []changelog.Release {
	...
	return changelog.Since(changelog.Parse(sidesave.Changelog), a.updatedFrom)
}
...
func (a *App) SelectBackupFile(title string) string {
	...
	file, err := runtime.OpenFileDialog(a.ctx, runtime.OpenDialogOptions{
		Title: title,
		Filters: []runtime.FileFilter{
			{DisplayName: "SideSave backup (*.sscb)", Pattern: "*.sscb"},
			{DisplayName: "All files", Pattern: "*.*"},
		},
	})
	if err != nil {
