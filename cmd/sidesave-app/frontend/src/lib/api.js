// REST + WebSocket client for the embedded SideSave daemon.
...
export async function initApi() {
  ...
  throw new Error(
    `The window can't reach SideSave's background service at ${baseURL} (${lastErr?.message ?? 'no response'}). ` +
      `This is usually another program blocking local connections (firewall/antivirus), or a leftover SideSave still running — ` +
