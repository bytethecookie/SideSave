...
{:else}
  <div class="pill-tabs" style="margin-bottom: 18px;">
    ...
    <button class="discord-tab" on:click={() => native.openExternal(DISCORD_URL)} title="Open the SideSave Discord in your browser">
  ...
  {#if tab === 'general'}
    ...
    <div class="card" style="margin-top: 14px;">
      ...
      <label class="check">
        ...
        Start SideSave when the computer starts
      </label>
  ...
  {:else if tab === 'sync'}
    ...
    <div class="card" style="margin-top: 14px;">
      ...
      <p class="hint" style="margin-top: 6px;">
        ...
        <strong>Cloud Backup</strong> page. Snapshots are stored in an <strong>SideSave</strong> folder.
      </p>
      <div class="field" style="margin-top: 14px;">
        <label for="s-driveid">Google Drive folder ID (optional)</label>
        <input id="s-driveid" bind:value={draft.cloudSync.folderId} placeholder="Leave blank to use the auto-created SideSave folder" />
        <span class="hint">
  ...
  {:else if tab === 'storage'}
    <div class="card">
      ...
      <div class="field">
        ...
        <div class="path-row">
          <input id="s-sync-backups" bind:value={draft.syncBackupsDir} placeholder="Default: ~/.sidesave/backups" />
    ...
    <div class="card support-card">
      <div class="support-hero">
        ...
        <div class="support-hero-text">
          <h3 class="support-title">Support SideSave</h3>
      ...
      <p class="support-note">
        Payment is handled entirely by Gumroad — SideSave never sees your card details.
      </p>
    </div>
  {/if}
